...
def ap_per_class(tp, conf, pred_cls, target_cls, plot=False, save_dir='.', names=(), eps=1e-16, prefix=''):
    ...
    p, r, f1 = p[:, i], r[:, i], f1[:, i] # P,R del F1 Máximo para cada CLASE.
...
class ConfusionMatrix:
    ...
    def plot(self, normalize=True, save_dir='', names=()):
        ...
        ax.set_title('Matriz de Confusión_Confianza_{}_IOU_{}'.format(self.conf,self.iou_thres))
        ...
        ax.set_xlabel('True')
        ax.set_ylabel('Predicted')
        ax.set_title('Confusion Matrix_confi_{}_IOU_{}'.format(self.conf,self.iou_thres))
